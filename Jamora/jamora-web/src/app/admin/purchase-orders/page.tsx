...
export default async function PurchaseOrdersPage() {
  ...
  return <div className="space-y-6"><div><p className="text-xs font-semibold uppercase tracking-[0.2em] text-blue-600">Transactions</p><h1 className="mt-2 text-3xl font-bold tracking-tight">Purchase orders</h1><p className="mt-2 text-sm text-slate-500">Order production batches and receive them directly into traceable inventory.</p></div><AdminPurchaseOrdersManager purchaseOrders={purchaseOrders} suppliers={suppliers} products={products} /></div>;
}
